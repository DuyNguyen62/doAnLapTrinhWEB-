...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Tổng bình luận
    axiosJWT.get(`${BASE_URL}/comment/admin`, { headers: { Authorization: `Bearer ${user?.accessToken}` }, withCredentials: true })
      .then(res => setCommentCount(res.data.data?.totalItems || 0));
  }, []);
